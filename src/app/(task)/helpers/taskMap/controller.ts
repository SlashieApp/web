 ...
 *   selected) → markers → selection (expand selected pin) →
...
export function createTaskMapController(args: {
  ...
  /**
   * Selected browse pin stays at its lat/lng (bottom-anchored tip). Do not
   * lift the marker — that was a zone-circle layout workaround.
   */
