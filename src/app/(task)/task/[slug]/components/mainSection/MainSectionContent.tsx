...
import { Button, ImageGallery, type ImageGalleryItem, SectionCard } from '@ui'
...
export function MainSectionContent() {
  ...
  return (
    <Stack gap={{ base: 6, lg: 8 }} w="full">
      <SectionCard eyebrow="Media" heading="Photos" bodyGap={3}>
        {photoItems.length > 0 ? (
      ...
      <SectionCard eyebrow="Scope" heading="Description" bodyGap={4}>
      ...
      {chips.length > 0 ? (
        <SectionCard
          eyebrow="Timing"
          heading="Preferred availability"
          bodyGap={4}
        >
          <HStack
            gap={3}
