# Slashie Web — Engineering docs

Wiki-facing engineering notes for the Next.js app. Start here:
...
When conventions change, update the **Coding Guidebook** first, then the matching Cursor rules.
