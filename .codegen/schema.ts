...
export type Query = {
  ...
  /** Tasks near a map center, sorted by distance. Defaults: London, 10 mile radius. */
  tasks: Array<Task>;
  worker?: Maybe<Worker>;
};
...
export type TasksQuery = { tasks: Array<{ id: string, title: string, description: string, location?: string | null, locationLat?: number | null, locationLng?: number | null, status: TaskStatus, createdByUserId: string, createdAt: any, dateTime?: any | null, category?: string | null, priceOfferPence?: number | null, paymentMethod?: TaskPaymentMethod | null, contactMethod?: string | null, offers: Array<{ id: string, taskId: string, workerUserId: string, pricePence: number, message?: string | null, status: OfferStatus, createdAt: any }> }> };
...
export type TaskQuery = { task?: { id: string, title: string, description: string, location?: string | null, status: TaskStatus, createdByUserId: string, createdAt: any, dateTime?: any | null, category?: string | null, priceOfferPence?: number | null, paymentMethod?: TaskPaymentMethod | null, contactMethod?: string | null, offers: Array<{ id: string, taskId: string, pricePence: number, message?: string | null, workerUserId: string, status: OfferStatus, createdAt: any }> } | null };
...
export type BrowseTasksQuery = { tasks: Array<{ id: string, title: string, description: string, location?: string | null, locationLat?: number | null, locationLng?: number | null, status: TaskStatus, priceOfferPence?: number | null, createdAt: any, category?: string | null }> };
...
export type MakeOfferMutation = { makeOffer: { id: string, amount: number, message?: string | null, status: OfferStatus } };
...
export type PostTaskMutation = { postTask: { id: string, title: string, description: string, status: TaskStatus } };
...
export type ProfessionalProfileQuery = { worker?: { id: string, bio?: string | null, isVerified: boolean, rating?: number | null, reviewCount?: number | null, yearsExperience?: number | null, location: { address?: string | null, lat?: number | null, lng?: number | null }, skills: Array<{ id: string, name: string }> } | null };
...
export type SearchProfessionalsQuery = { searchProfessionals: Array<{ id: string, bio?: string | null, rating?: number | null, reviewCount?: number | null, user: { id: string, firstName: string, lastName: string } }> };
...
export type WorkerQuery = { worker?: { userId: string, rating?: number | null, reviewCount?: number | null } | null };
...
export type RegisterAsProMutation = { registerAsPro: { id: string, isProMember: boolean } };
...
export type UpdateMyMembershipMutation = { updateMyMembership: { isPaid: boolean, tier: MembershipTier, renewsAt?: any | null } };
...
export type UpdateMyProfileMutation = { updateMyProfile: { id: string, profile: { name?: string | null, contactNumber?: string | null } } };
...
export type UpdateMySettingsMutation = { updateMySettings: { id: string, settings: { isProfilePrivate: boolean, marketingEmails: boolean } } };

export type UpgradeToProMembershipMutationVariables = Exact<{ [key: string]: never; }>;


export type UpgradeToProMembershipMutation = { upgradeToProMembership: { id: string, isProMember: boolean } };
