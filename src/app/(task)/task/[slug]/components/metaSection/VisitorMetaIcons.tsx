...
/** Grid-style icon used for budget (task detail meta reference). */
export function IconBudgetGrid() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      <title>Budget</title>
      <rect
...
export function IconUrgency() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      <title>Urgency</title>
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.6" />
      <path
        d="M12 8v5M9 13l3 3 3-3"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconTag() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path
        d="M3 5.5v5.7c0 .4.2.8.5 1.1l7.9 7.9c.6.6 1.5.6 2.1 0l5.7-5.7c.6-.6.6-1.5 0-2.1L11.3 4.6c-.3-.3-.7-.5-1.1-.5H5.5A2.5 2.5 0 0 0 3 5.5Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
